...
class orderLabels extends \tcpdf 
{
    ...
    */
    ...
    function addOrderLabels($params)
    {
        ...
        $forWorkOrders = $type == 'work';
        $table = $forWorkOrders ? 'workorderlabel' : 'neworderlabel';

        $title = $forWorkOrders ? 'Work Order' : 'New Order';
        $sql = 'SELECT  LPAD(
                         CONCAT(userID, assignNumber),
                         10, 0
                     ) AS barcode,
